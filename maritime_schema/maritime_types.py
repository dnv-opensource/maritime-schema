...
def publish_schema():
    ...
    generate_from_filename(os.path.join('input_schema', 'input_schema.json'), os.path.join('input_schema', 'input_schema.html'), config=config)
    ...
    generate_from_filename(os.path.join('output_schema', 'output_schema.json'), os.path.join('output_schema', 'output_schema.html'), config=config)
